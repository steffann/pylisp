...
key = 'devdevdev'
map_servers = [ETRRegistration(u'83.247.10.218', key_id=key_id, key=key, proxy_map_reply=True),
               ETRRegistration(u'87.195.109.18', key_id=key_id, key=key, proxy_map_reply=True)]
